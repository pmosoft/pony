...
public class GensCommByCopy2 {
     ...
     * 3단계 : 타겟 프로그램 리팩토링 생성  
     *****************************************/
    public void replaceSrcPgmToTarPgm(String srcPathNm, String srcFileNm, String tarPathNm, String tarFileNm, Gens gens) throws Exception {
     ...
     * 4단계 : 리팩토링 룰  
     *****************************************/
     public String replaceRule(String line, Gens gens) { return null;}
